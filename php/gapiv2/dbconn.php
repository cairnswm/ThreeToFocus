...
include_once __DIR__ . "/../threetofocusconfig.php";

// Create a global $gapiconn exists for the MySQL connection
global $gapiconn;
$gapiconn = new mysqli($threetofocusconfig["server"], $threetofocusconfig["username"], $threetofocusconfig["password"], $threetofocusconfig["database"]);
