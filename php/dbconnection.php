...
include_once "./threetofocusconfig.php";
global $conn;
...
function getConnection() {
    ...
    if (!isset($conn)) {
        global $threetofocusconfig;
        $conn = new mysqli($threetofocusconfig["server"], $threetofocusconfig["username"], $threetofocusconfig["password"], $threetofocusconfig["database"]);
